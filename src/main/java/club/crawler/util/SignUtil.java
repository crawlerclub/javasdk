...
import club.crawler.ApiException;
...
public class SignUtil {
    ...
    public static String hmacSha256(String key, String data) throws ApiException {
        try {
            ...
            e.printStackTrace();
            throw new ApiException(-1, "Fail to generate HMAC-SHA256 signature");
        }
    }
